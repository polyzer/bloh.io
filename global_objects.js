...
{
	/*It defines mode and where game must get data at initialising state*/
	this.WorkingMode = GAME_CONSTANTS.WORKING_MODE.LOCAL;
...
GlobalObjects.prototype.addAllInputElements = function ()
{
	...
	this.PointsCounterDiv.setAttribute("id", "BulletsCounterDiv");
...
GlobalObjects.prototype.getWorkingMode = function ()
{
...
{
	var tlet = percent;// * this.LocalPlayerHealthLineDiv.dataset.widthCoeff;
	if(tlet > 0)
...
{
	this.Person = new Person({WorkingMode: this.WorkingMode});
};
