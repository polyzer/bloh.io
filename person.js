...
{
	var json_params_names = ["WorkingMode"];
	...
	*/
	...
	{
		/*В ВК-моде мы всем распоряжаемся в зависимости от id*/
		case GAME_CONSTANTS.WORKING_MODE.VK:
			this.parseVKVars();
			this.checkPersonAtDB();
			break;
		/*В Локальном моде мы сами генерируем, для теста*/
		case GAME_CONSTANTS.WORKING_MODE.LOCAL:
			this.generateAllUserData();
			break;
	}
...
Person.prototype.generateAllUserData = function ()
{
	this.VKVars.user_id = generateRandomString(10);
	this.generateID();
